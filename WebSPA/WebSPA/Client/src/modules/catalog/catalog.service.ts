...
export class CatalogService {
    ...
    constructor(private service: DataService, private configurationService: ConfigurationService) {
        this.configurationService.settingsLoaded$.subscribe(x => {
            ...
            this.catalogUrl = 'http://localhost:57425/c/api/v1/catalog/items';
            this.brandUrl = 'http://localhost:57425/c/api/v1/catalog/catalogbrands';
            this.typesUrl = 'http://localhost:57425/c/api/v1/catalog/catalogtypes';
        });
    }
